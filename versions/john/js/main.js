function tabs(a,g,j){
	...
	var g=a.getElementsByTagName(g),d=[],c;
	this.active;this.total=g.length;
	this.container=a;
	...
	for(var b=0;b<g.length;b++){
		...
		nav.id="mobiles";
		nav.innerHTML='<a href="#" onclick="'+d+'.prev(); return false">'+c.prev+'</a><a href="#" onclick="'+d+'.next(); return false">'+c.next+"</a>";this.container.insertBefore(nav,this.container.firstChild);return this};
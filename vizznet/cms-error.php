...
<body>
	<article id='main' class='about-us'>
		<nav id='globaheader'>
			...
			<div id='vizz-menu'>
				<ul id='vizz-pages'> 
						<li><a href='http://www.vizznet.co.uk/index.php'>Home</a></li>
						<li><a href='http://www.vizznet.co.uk/about-us.php'>About Us</a></li>
						<li><a href='http://www.vizznet.co.uk/products.php'>Products</a></li>
						<li><a href='http://www.vizznet.co.uk/offers.php'>Offers</a></li>
						<li><a href='http://www.vizznet.co.uk/contact-us.php'>Contact Us</a></li>
				</ul>
				<ul id='bottons'>
		...
		<section id='content'>
			<h1>Something unexpected happened and your request could not be completed</h1>
			<p>Internal server error or service unavailable.  There was a fatal error processing you transaction your account will not have been added, please try again later.
        The account has been passed to CMS for further inspection. This does not necessarily mean that the account will not be accepted; it simply means that there was insufficient data to accept the account immediately. A decision is usually made by the next working day.</p>
		</section>
